...
<div class="container-fluid">
    ...
    <div style="width: 529px;">
        <div class="row">
            <div class="col-md-6">
                <a href="{{ route('unduhDataTransaksiSelesai') }}" class="btn btn-outline-danger mb-2" style="width: 264px;"><i class="fas fa-print"></i> Cetak Data Transaksi Selesai</a>
            </div>
            <!-- <div class="col-md-6">
            ...
            <tbody id="myTable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                        <a href="{{ route('unduhKwitansi', $t->id) }}" class="text-success">Reservasi Selesai</a>
                        @endif
                    </td>
                </tr>
                @endforeach
