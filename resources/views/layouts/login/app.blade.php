    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #78221c">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link {{request()->is('home') ? ' active' : ''}}" href="{{ route('homeUser') }}">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{request()->is('service') ? ' active' : ''}}" href="{{ route('serviceUser') }}">Service <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{request()->is('notifikasi') ? ' active' : ''}}" href="{{ route('notifikasi') }}">Notifikasi <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <div class="dropdown">
                            <a href="" class="btn {{request()->is('login/user') ? ' active' : ''}} text-light dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
