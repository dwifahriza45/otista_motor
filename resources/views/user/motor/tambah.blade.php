...
@section('title', 'Tambah Data Motor - Otista Motor')
...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-white text-center" style="background-color: #78221c">{{ __('Tambah Motor') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('addMotor') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nama_motor" type="text" class="form-control @error('nama_motor') is-invalid @enderror" name="nama_motor" autocomplete="nama_motor" value="{{ old('nama_motor') }}" autofocus placeholder="Masukkan nama motor . . .">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="merk" type="text" class="form-control @error('merk') is-invalid @enderror" name="merk" autocomplete="merk" value="{{ old('merk') }}" autofocus placeholder="Masukkan merk motor . . .">
